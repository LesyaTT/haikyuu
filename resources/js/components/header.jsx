  ...
  return (
    <>
      <header className="flex justify-between w-full h-24 items-center">
        <img src='/imgs/logo.svg' className="md:h-[120px] xl:h-[160px]" alt="" srcset="" />
        ...
        <div className="flex items-center">
          <button className="md:w-[35px] xl:w-[45px] h-[45px] mr-[15px]">
            <svg
...
const Link = ({ color, text, adress }) => {
  return (
    <a
      className={`md:text-2xl xl:text-3xl text-${color} link-wrapper hover:text-lightorange`}
      href={`${adress}`}
    >
      {text}
    </a>
